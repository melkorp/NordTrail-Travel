...
export default async function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-bg text-text flex flex-col items-center justify-center gap-4">
      ...
      <Link
        href="/admin/media"
        className="inline-flex items-center gap-2 rounded-xl border border-accent-bright/30 bg-accent-bright/8 px-5 py-3 text-sm font-medium text-accent-bright transition-all hover:border-accent-bright/50 hover:bg-accent-bright/15"
      >
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          <path
            d="M1 13h12M1 1h12M1 1v12M13 1v12M5 1v12M9 1v12"
